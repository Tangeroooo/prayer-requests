...
export type MinistryUnitType = 'small_group' | 'group_leadership' | 'pastor_team' | 'mc_team'
...
export type MemberRole = 'leader' | 'sub_leader' | 'pastor' | 'mc'
...
export const MINISTRY_UNIT_TYPE_ICONS: Record<MinistryUnitType, string> = {
  small_group: 'groups',
  group_leadership: 'workspace_premium',
  pastor_team: 'church',
  mc_team: 'mic',
}
